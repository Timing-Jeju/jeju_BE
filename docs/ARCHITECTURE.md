...
- `20260913000000` `#78` 프로필 이미지 Storage migration은 `user_profiles` 상태, cleanup outbox와 public bucket의 immutable INSERT-only RLS를 additive하게 적용합니다.
- `20260915000000`은 #38 시간표 provenance와 TAGO route reference scope를 additive하게 분리합니다.
