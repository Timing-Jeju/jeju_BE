...
- 마이그레이션은 최초 public 스키마부터 timestamp순으로 누적 적용하며, `20260819000000` TAGO 정류장 적재 뒤 `20260820000000` KMA 예보, `20260821000000` TAGO 도착정보, `20260822000000` 관광지-정류장 후보 link 순서를 예약합니다. 병합 전 선택적 선행 migration이 없어도 timestamp 중복을 거부하고 현재 존재하는 canonical migration 전체를 적용합니다.
