...
- `supabase/migrations/20260730040000_import_run_lineage_retention.sql`: snapshot 보존기간 이후에도 외부 정규화 행의 마지막 import run 삭제 차단
