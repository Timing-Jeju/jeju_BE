...
insert into route_stops (
  route_id, stop_id, direction_key, stop_sequence, travel_minutes_from_prev, import_run_id
) values
('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'eastbound', 1, null, '00000000-0000-0000-0000-000000000001'),
('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', 'eastbound', 2, 80, '00000000-0000-0000-0000-000000000001'),
('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000003', 'eastbound', 3, 18, '00000000-0000-0000-0000-000000000001');

insert into timetable_entries (
  id, route_id, stop_id, direction_key, service_day_type, departure_time,
  trip_key, valid_from, source_provider, import_run_id
) values
('41000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'eastbound', 'daily', '09:40', '201-0940', current_date, 'fixture', '00000000-0000-0000-0000-000000000001'),
('41000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', 'eastbound', 'daily', '11:00', '201-0940', current_date, 'fixture', '00000000-0000-0000-0000-000000000001'),
('41000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000003', 'eastbound', 'daily', '11:18', '201-0940', current_date, 'fixture', '00000000-0000-0000-0000-000000000001');
