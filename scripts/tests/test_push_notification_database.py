...
class PushNotificationDatabaseTest(unittest.TestCase):
    ...
    def test_docker_init_applies_trip_saved_push_correction_then_seed_exactly_once(self):
        ...
        mounts = (
            ...
            (
                "./supabase/migrations/20260918000017_planned_route_request_hash_policy.sql",
                "/docker-entrypoint-initdb.d/055_planned_route_request_hash_policy.sql",
            ),
            (
        ...
        for target in migration_targets:
            expected_count = (
                ...
                if target.endswith(("054_planned_route_reference_integrity.sql", "055_planned_route_request_hash_policy.sql"))
                else 2
            )
