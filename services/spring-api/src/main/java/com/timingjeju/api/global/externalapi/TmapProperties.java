...
@ConfigurationProperties("app.external-api.tmap")
  ...
  public TmapProperties {
    ExternalApiPropertyValidation.validate(
        new ExternalApiPropertyValues(
            ExternalApiProvider.TMAP, enabled, apiKey, baseUrl, connectTimeout, readTimeout));
  }

  @Override
  public ExternalApiProvider provider() {
    return ExternalApiProvider.TMAP;
  }
