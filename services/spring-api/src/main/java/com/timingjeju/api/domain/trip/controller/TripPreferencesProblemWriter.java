...
@Component
final class TripPreferencesProblemWriter {
  private final ProblemResponseWriter writer;
  private final ProblemCodeRegistry fallback;
  private final TripPreferencesProblemDefinitions definitions;

  TripPreferencesProblemWriter(
      ProblemResponseWriter writer,
      ProblemCodeRegistry fallback,
      TripPreferencesProblemDefinitions definitions) {
    this.writer = writer;
