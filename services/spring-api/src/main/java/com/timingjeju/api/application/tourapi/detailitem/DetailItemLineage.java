...
public record DetailItemLineage(
    String operationKey, String requestFingerprint, UUID snapshotId, UUID importRunId) {
  public DetailItemLineage {
    if (!"detailInfo2".equals(operationKey)) {
      throw new IllegalArgumentException("operationKey는 detailInfo2여야 합니다.");
    }
