...
@Schema(name = "TripDetailLegacyV1", additionalProperties = Schema.AdditionalPropertiesValue.FALSE)
public record TripDetailLegacyV1Response(
    ...
    @ArraySchema(
            ...
            maxItems = 30,
            arraySchema = @Schema(requiredMode = Schema.RequiredMode.REQUIRED),
            schema = @Schema(implementation = TripDayLegacyV1Response.class))
        List<TripDayLegacyV1Response> days,
    @Schema(
            requiredMode = Schema.RequiredMode.REQUIRED,
            nullable = true,
            types = {"string", "null"},
