...
class KmaVillageForecastScheduleTest {
  ...
  void fixtureIdentifiesTheOfficial20241128NoticeAndAttachment() throws Exception {
    try (var input =
      ...
      assertThat(fixture.path("earlyExtendedDayOffset").asInt()).isEqualTo(3);
      assertThat(fixture.path("lateExtendedDayOffset").asInt()).isEqualTo(4);
      assertThat(fixture.path("officialSlotCounts").path("0200").asInt()).isEqualTo(77);
      assertThat(fixture.path("officialSlotCounts").path("2300").asInt()).isEqualTo(80);
    }
  }
