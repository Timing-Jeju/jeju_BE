...
class TransportEventMigrationContractTest {
  private static final String MIGRATION = "20260918000003_trip_transport_event_contract.sql";
  ...
  void migration은_legacy를_추측보정하지않고_XOR_canonical_server_writer를_강제한다() throws Exception {
    ...
    assertThat(sql)
        ...
        .contains("revoke all on function public.validate_trip_calendar_child() from public")
